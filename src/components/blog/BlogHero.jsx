  ...
  return <div className="bg-[url(/assets/images/webp/bg-hero.webp)] bg-cover bg-no-repeat bg-center relative">
    ...
    <div className="container max-w-[1140px] xl:px-0 px-4 md:px-6 mx-auto">
      <div className="pt-[230px] pb-[326px] relative">
        ...
        <Image src="/assets/images/webp/blog-3.webp" alt="blog-3" width={155} height={121} className="absolute bottom-[14%] left-0 md:bottom-[25%] md:left-[20.39%] rotate-[10deg]" />
        <Image src="/assets/images/webp/blog-4.webp" alt="blog-4" width={166} height={129} className="absolute bottom-[10%] right-0 md:bottom-[21%] md:right-[15.39%] -rotate-[11deg]" />
        {/* icon images */}
        <div className="min-w-10 sm:min-w-12 h-10 sm:h-12 bg-white border border-black/10 shadow-light-dark rounded-full flex justify-center items-center absolute -left-2 md:-left-5 top-[25%] rotate-[15deg]">
        ...
        <div className="min-w-10 sm:min-w-12 h-10 sm:h-12 bg-white border border-black/10 shadow-light-dark rounded-full flex justify-center items-center absolute left-[10%] md:left-[27%] top-[2%] md:top-[14%] rotate-[14deg] z-10">
        ...
        <div className="min-w-10 sm:min-w-12 h-10 sm:h-12 bg-white border border-black/10 shadow-light-dark rounded-full flex justify-center items-center absolute right-[7%] bottom-[35%] rotate-[2deg] z-10">
