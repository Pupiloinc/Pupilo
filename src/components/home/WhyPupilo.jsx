                ...
                <div className="flex justify-between gap-5 max-sm:gap-8 max-lg:flex-col mb-6 max-lg:pb-5 items-center">
                    <div className="max-w-[627px] max-lg:flex max-lg:flex-col max-lg:items-center max-lg:justify-center">
                        <Title text="Learn our Difference:
                            Why Pupilo?" className="max-w-[506px] max-sm:max-w-[412px] max-lg:mx-auto max-lg:text-center" />
                    ...
                    <div className="max-lg:w-full max-lg:flex max-lg:justify-center">
                        <Image
                            ...
                            width="364"
                            height="272"
                            className='max-lg:max-w-[600px] rounded-3xl max-lg:rounded-2xl max-md:rounded-xl max-sm:rounded-lg max-lg:w-full'
                        />
                    </div>
                </div>
