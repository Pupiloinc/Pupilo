          ...
          <div className='max-w-[524px] flex-col flex gap-10 max-lg:gap-8 max-sm:gap-6'>
            ...
            <div className='flex gap-4 flex-col'>
              ...
              <div className="flex gap-2 max-lg:justify-center max-lg:items-center">
                <a href="https://www.instagram.com/hellopupilo" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 hover:opacity-80">
                  <Icons icon="instagramIcon" />
                </a>
                <a href="https://www.facebook.com/hellopupilo" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300 hover:opacity-80">
