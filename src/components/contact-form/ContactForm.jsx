...
const ContactForm = () => {
    ...
    return (
        <div className='min-h-screen flex max-md:py-[60px] relative max-lg:py-[100px] py-[30px] justify-center items-center bg-[url(/assets/images/webp/bg-hero.webp)] bg-cover bg-no-repeat bg-center'>
            <Image src="/assets/images/png/form-ellips-start.png" alt='bottom-left' width={325} height={325}  className='absolute bottom-0 left-0 pointer-events-none max-lg:hidden'/>
                        <Image src="/assets/images/png/form-ellipse.png" alt='left-ellipse' width={180} height={340}  className='absolute top-1/3 right-0 pointer-events-none max-lg:hidden'/>
                        <Image src="/assets/images/png/form-ellips-start-yello.png" alt='left-ellipse' width={325} height={325}  className='absolute top-0 left-[16%] pointer-events-none max-lg:hidden'/>
            <ToastContainer />
                ...
                <div className='flex gap-10  justify-between max-lg:flex-col max-lg:items-center'>
                    <div className='max-w-[524px] flex-col flex gap-10 max-lg:gap-8 max-sm:gap-6'>
                        <div className='flex flex-col gap-4 max-md:gap-2'>
                            <h2 className='max-lg:text-center font-semibold text-[38px] sm:text-[43px] md:text-5xl lg:text-[58px] xl:text-custom-6xl leading-120 text-dark-black mt-4 relative z-10 lg:max-w-[524px]'>Let’s Connect. <span className='block text-purple'>Build. Empower.</span></h2>
                        ...
                        <div className='flex gap-4 flex-col '>
                            <p className='md:text-2xl text-xl font-semibold leading-120 max-lg:text-center'>Follow us :</p>
                    ...
                    <div className='p-6 max-lg:p-4 max-sm:p-3 relative max-lg:rounded-2xl max-sm:rounded-xl border-black/4 bg-white max-w-[550px] w-full form-shadow rounded-3xl border border-solid'>
                        <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-md:gap-3.5'>
                            ...
                            <div className='max-w-[502px] max-xl:flex-col w-full flex gap-4'>
                                <div className='max-w-[243px]  max-xl:max-w-[unset] w-full'>
                                    <CustomInput
                                        name="childName"
                                        type="text"
                            ...
                            <div className='max-w-[502px] w-full bg-dark-black/8 h-[1px]'></div>
