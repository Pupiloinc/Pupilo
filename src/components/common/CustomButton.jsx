...
const CustomButton = ({ iconClass, text, className, iconColor }) => {
  return (
    <button
      className={`flex gap-2 py-3.5 px-8 group cursor-pointer bg-yellow rounded-full text-dark-black font-semibold leading-150 max-sm:text-sm max-sm:py-2.5 max-sm:px-6 ${className}`}
    >
      {text}
