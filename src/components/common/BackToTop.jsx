...
const BackToTop = () => {
  ...
  return (
    <button
      ...
      id="back-to-top"
      className={`size-12 cursor-pointer flex justify-center items-center rounded-full z-50 bg-purple group transition-all ease-linear duration-300 fixed bottom-1 right-1 md:bottom-3 md:right-3 group max-md:scale-75 ${
