...
const NewsLetterPopUp = ({ onClose }) => {
    return (
        <div
            className='bg-black/60 min-h-screen fixed inset-0 max-sm:px-4 z-50'
            onClick={onClose}
        >
            <div className='flex items-center justify-center h-screen'>
                <div
                    className='max-w-[734px] bg-newsletter bg-cover bg-no-repeat w-full p-5 md:p-10 lg:p-[60px] rounded-4xl'
                    onClick={e => e.stopPropagation()}
                >
                    <div className="flex justify-center items-center">
                        <Icons className="max-md:min-w-[120px] max-md:h-[120px]" icon="newsletterIcon" />
                    </div>
