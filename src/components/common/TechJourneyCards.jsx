            ...
            >
              <div className="flex flex-col gap-6 md:gap-7">
                <div className="flex flex-col gap-2 max-lg:items-start">
                  <div
                    className={`${badgeBorder || "border-white"
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <h3
                      className={`text-5xl max-lg:text-4xl max-md:text-custom-4xl max-sm:text-3xl leading-120 font-semibold ${headingClass} ${textColor || "text-white"
                        }`}
                    >
                      {title}
                    </h3>
                  ...
                  <Description
                    className={`${descriptionClass} ${textColor || "text-white"
                      } opacity-80`}
                    text={description}
                  />
                </div>
