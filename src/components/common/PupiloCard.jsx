...
const PupiloCard = ({title , description , buttonText , buttonClass , buttonIconcolor , imageWidth , imageAlt , imageSrc , cardTheme , textColor , rightPosition , learnMoreLink , learnMoreIcon , imageClass , headingClass , descriptionClass }) => {
    return (
        <div className='overflow-hidden '>
            <div className={`p-8 max-lg:p-7 max-md:p-6 max-sm:p-4 relative rounded-3xl max-md:rounded-2xl max-sm:rounded-xl flex max-lg:flex-col ${cardTheme || 'bg-light-purple'}`}>
                ...
                <div className='w-full max-lg:justify-center max-lg:flex'>
