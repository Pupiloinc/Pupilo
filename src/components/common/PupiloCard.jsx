...
const PupiloCard = ({title , description , buttonText , buttonClass , buttonIconcolor , imageWidth , imageAlt , imageSrc , cardTheme , textColor , rightPosition , learnMoreLink , learnMoreIcon , imageClass }) => {
    return (
        <div className='overflow-hidden '>
            <div className={`p-8 max-lg:p-7 max-md:p-6 max-sm:p-4 relative rounded-3xl max-md:rounded-2xl max-sm:rounded-xl flex flex-wrap ${cardTheme || 'bg-light-purple'}`}>
                ...
                <div className='w-1/2 max-lg:w-full max-lg:justify-center max-lg:flex'>
                    ...
                    <Image className={`absolute z-20 max-lg:relative max-lg:!right-0 max-sm:w-full ${imageClass}`} style={{right : rightPosition || '20px'}} width={imageWidth} height={290} alt={imageAlt} src={imageSrc} />
                </div>
            </div>
        </div>
    )
