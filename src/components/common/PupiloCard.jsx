    ...
    return (
        <div className='overflow-hidden max-lg:px-10 max-sm:px-5 max-[575px]:!px-0'>
            <div className={`p-8 max-lg:p-7 max-md:p-6 max-sm:p-4 relative rounded-3xl max-md:rounded-2xl max-sm:rounded-xl flex max-lg:flex-col max-lg:gap-6 max-md:gap-3 max-[575px]:max-w-[464px] max-[575px]:mx-auto ${cardTheme || 'bg-light-purple'}`}>
                <div className={`w-full relative z-20`}>
                    <div className={`flex flex-col gap-6`}>
                        ...
                        <div className='flex gap-10 max-sm:gap-4 max-lg:justify-center items-center'>
                            <CustomButton href="/contact-form" iconColor={buttonIconcolor || '#010101'} text={buttonText} className={buttonClass || 'bg-white'} />
                ...
                <Image width={584} height={460} alt='layer' className='absolute pointer-events-none top-10 z-10 -right-[50px] max-lg:top-[unset] max-lg:!bottom-0' src={pupiloCardLayer || '/assets/images/png/pupilo-card-layer.png'} />
                <Image className={`absolute z-20 max-lg:relative max-lg:mx-auto max-lg:!right-0 max-sm:w-[90%] ${imageClass}`} style={{ right: rightPosition || '20px' }} width={imageWidth} height={290} alt={imageAlt} src={imageSrc} />
            </div>
        </div>
    )
}
