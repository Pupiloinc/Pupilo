...
const OurMission = () => {
  return (
    <section className="lg:py-[160px] md:py-20 py-14  px-4">
      <div className=' flex max-[790px]:flex-wrap gap-6 items-center max-w-[1140px] mx-auto'>
      ...
      <div className="w-full min-[790px]:w-1/2 xl:space-y-6 space-y-4">
          <div className='xl:p-6 p-4 bg-white  hover:bg-[#875BF7] group rounded-[30px] transition-all duration-500'>
            <h2 className="md:text-[32px] text-3xl font-semibold leading-[120%] text-black group-hover:text-white xl:mb-3 mb-[6px] transition-all duration-500">Our Mission</h2>
            <p className="text-[#4E4E4E] group-hover:text-white xl:text-base text-sm leading-[150%] font-normal transition-all duration-500">
          ...
          <div className='xl:p-6 p-4 bg-white  hover:bg-[#875BF7] group rounded-[30px] transition-all duration-500'>
            <h2 className="md:text-[32px] text-3xl font-semibold leading-[120%] text-black group-hover:text-white xl:mb-3 mb-[6px] transition-all duration-500">Our Vision</h2>
            <p className="text-[#4E4E4E] group-hover:text-white xl:text-base text-sm leading-[150%] font-normal transition-all duration-500">
