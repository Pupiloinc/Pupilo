...
const ComparisonTable = () => {
  ...
  return (
    <div className="max-md:bg-fade-purple bg-our-coding bg-full max-lg:!bg-cover relative sm:pt-20 sm:pb-[64px] py-[60px]">
      ...
      <div className="container max-w-[1140px] xl:px-0 sm:px-6 px-4 mx-auto">
        ...
        />
        <div className="overflow-x-scroll scrollbar-custom ps-4">
          <div className="xl:max-w-[1124px] mx-auto">
            <div className="flex items-center gap-[33px]  font-semibold text-sm sm:text-base text-dark-black lg:pb-6 pb-5">
              ...
              <p className="font-semibold text-xl leading-120 text-dark-black xl:min-w-[150px] min-w-[110px]">Structure</p>
            ...
            {FORMAT_COMPARISON_DATA.map((row, i) => (
              <div key={i} className={`flex items-center gap-[33px] pb-3`}>
                ...
                <StarRating className="xl:!min-w-[150px] !min-w-[110px]" count={row.structure} />
