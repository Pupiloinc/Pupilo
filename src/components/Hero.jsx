    ...
    <div className="container max-w-[1140px] xl:px-0 px-4 md:px-6 mx-auto">
      <div className="flex justify-between mt-[40px] lg:mt-[60px] pb-[60px] md:pb-[100px] lg:pb-[120px] max-lg:flex-col max-lg:items-center">
        <div className="w-full lg:w-1/2 lg:mt-6">
          ...
          <h2 className={`max-lg:text-center font-semibold text-[34px] sm:text-[43px] md:text-5xl lg:text-[55px] xl:text-custom-[60px] leading-120 text-dark-black mt-4 relative z-10 lg:max-w-[420px] ${pathName === "/" && "text-yellow capitalize lg:max-w-[502px]"}`}>{blackText} <span className="text-purple block">{purpleText}</span></h2>
